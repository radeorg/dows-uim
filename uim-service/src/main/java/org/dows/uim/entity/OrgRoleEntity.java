...
@AllArgsConstructor
@Schema(name = "组织角色表")
@Table(value = "org_role", onUpdate = AutoFillDataListener.class, onInsert = AutoFillDataListener.class)
public class OrgRoleEntity extends BaseEntity<OrgRoleEntity> {
